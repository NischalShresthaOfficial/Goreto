...
class DolakhaPlacesController extends Controller
{
    public function fetchDolakhaPopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.6667,86.0333';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Dolakha']);
        ...
        return response()->json([
            'message' => 'Popular places across Dolakha fetched and stored successfully.',
