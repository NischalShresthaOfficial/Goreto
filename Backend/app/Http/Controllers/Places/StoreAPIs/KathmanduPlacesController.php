...
class KathmanduPlacesController extends Controller
{
    public function fetchKathmanduPopularPlaces()
    {
        ...
        $city = City::firstOrCreate(['city' => 'Kathmandu']);
        ...
        return response()->json([
            'message' => 'Popular places across Kathmandu fetched and stored successfully.',
