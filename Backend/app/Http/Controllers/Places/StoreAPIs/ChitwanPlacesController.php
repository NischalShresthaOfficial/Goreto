...
class ChitwanPlacesController extends Controller
{
    public function fetchChitwanPopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.5291,84.3542';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Chitwan']);
        ...
        return response()->json([
            'message' => 'Popular places across Chitwan fetched and stored successfully.',
