...
class SindhupalchokPlacesController extends Controller
{
    public function fetchSindhupalchokPopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.8939,85.5331';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Sindhupalchok']);
        ...
        return response()->json([
            'message' => 'Popular places across Sindhupalchok fetched and stored successfully.',
