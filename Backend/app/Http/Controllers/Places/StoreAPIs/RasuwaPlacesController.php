...
class RasuwaPlacesController extends Controller
{
    public function fetchRasuwaPopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.8682,85.3089';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Rasuwa']);
        ...
        return response()->json([
            'message' => 'Popular places across Rasuwa fetched and stored successfully.',
