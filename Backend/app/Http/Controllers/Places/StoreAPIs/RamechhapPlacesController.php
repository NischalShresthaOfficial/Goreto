...
class RamechhapPlacesController extends Controller
{
    public function fetchRamechhapPopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.2990,86.0896';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Ramechhap']);
        ...
        return response()->json([
            'message' => 'Popular places across Ramechhap fetched and stored successfully.',
