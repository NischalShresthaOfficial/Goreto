...
class KavrepalanchowkPlacesController extends Controller
{
    public function fetchKavrePopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.6250,85.5520';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Kavrepalanchowk']);
        ...
        return response()->json([
            'message' => 'Popular places across Kavrepalanchowk fetched and stored successfully.',
