...
class SindhuliPlacesController extends Controller
{
    public function fetchSindhuliPopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.1280,85.9915';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Sindhuli']);
        ...
        return response()->json([
            'message' => 'Popular places across Sindhuli fetched and stored successfully.',
