...
class DhadingPlacesController extends Controller
{
    public function fetchDhadingPopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.9053,84.8487';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Dhading']);
        ...
        return response()->json([
            'message' => 'Popular places across Dhading fetched and stored successfully.',
