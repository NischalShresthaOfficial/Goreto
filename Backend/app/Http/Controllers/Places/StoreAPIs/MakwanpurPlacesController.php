...
class MakwanpurPlacesController extends Controller
{
    public function fetchMakwanpurPopularPlaces()
    {
        $apiKey = config('services.google_maps.key');

        ini_set('max_execution_time', 600);

        $location = '27.4288,85.0384';
        $radius = 50000;
        ...
        $city = City::firstOrCreate(['city' => 'Makwanpur']);
        ...
        return response()->json([
            'message' => 'Popular places across Makwanpur fetched and stored successfully.',
